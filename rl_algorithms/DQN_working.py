...
model = DQN(
    ...
    exploration_final_eps=0.05,   # End with 1% exploration
    exploration_fraction=0.1,     # Decay over 30% of training
    verbose=1,
    learning_starts=8000,         # Start learning after 5000 steps
    train_freq=8,                 # Update every 2 steps (balanced)
    ...
    gradient_steps=8              # Gradient steps per update matched with update frequency
)

TOTAL_EPISODES = 150  # For 10 evaluations (250 / 25 = 10)
